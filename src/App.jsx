        ...
        if (err && !err.success) {
          ...
          if (err.message) {
            ...
            if (err.error_code === "signature_reject") {
              alert("Login failed: You canceled the signature request.");
            } else {
        ...
        <div className="container mx-auto flex mt-4">
          ...
          <main className="w-3/4 ml-4">
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <Routes>
                <Route path="/" element={<Home user={user} fetchVideos={fetchVideos} />} />
                <Route path="/studio" element={<CreatorStudio user={user} fetchVideos={fetchVideos} key={user} />} />
